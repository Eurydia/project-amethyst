...
pub async fn get_driver_report_general(
    ...
    get_one!("driver_general_reports", state.db)
}
...
pub async fn get_driver_report_medical(
    ...
    get_one!("driver_medical_reports", state.db)
}
...
pub async fn get_vehicle_report_general(
    ...
    get_one!("vehicle_general_reports", state.db)
}
#[tauri::command]
...
pub async fn get_vehicle_report_inspection(
    ...
    get_one!("vehicle_inspection_reports", state.db)
}
...
pub async fn get_pickup_route(
    ...
    get_one!("pickup_routes", state.db)
}
#[tauri::command]
...
pub async fn get_pickup_route_report_general(
    ...
    get_one!("pickup_route_general_reports", state.db)
}
