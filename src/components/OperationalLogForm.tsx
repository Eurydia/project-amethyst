...
import { AddRounded, WarningRounded } from "@mui/icons-material";
...
export const OperationalLogForm: FC<OperationalLogFormProps> = (props) => {
	...
	const [fieldRoute, setFieldRoute] = useState(slotProps.routeSelect.options[0]);
	...
	const isEndDateBeforeStartDate = fieldEndDate.isBefore(fieldStartDate);
