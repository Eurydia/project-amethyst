...
): Promise<number> => invoke("post_driver", driver);
...
): Promise<number> => invoke("post_pickup_route", route);

export const postPickupRouteReportGeneral = async (
  report: PickupRouteReportGeneralFormData,
): Promise<number> =>
  invoke("post_pickup_route_report_general", report);
//#endregion

//#region Vehicle
export const postVehicle = async (
  vehicle: VehicleFormData,
): Promise<number> => invoke("post_vehicle", vehicle);
...
export const postVehicleReportInspection = async (
  ...
  invoke("post_vehicle_report_inspection", report);
//#endregion
