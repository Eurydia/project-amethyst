...
export const getOperationLogAll = async (): Promise<
  OperationalLogModel[]
> => invoke("get_operational_log_all");

export const getOperationLogToday = async (): Promise<
  OperationalLogModel[]
...
export const getDriverReportGeneralAll = async (): Promise<
  DriverReportModel[]
...
> => await invoke("get_vehicle_report_general_all");
...
export const getVehicleReportInspectionAll =
  async (): Promise<VehicleReportInspectionModel[]> =>
...
//#region Pickup Route
export const getPickupRouteAll = async (): Promise<
  PickupRouteModel[]
...
export const getPickupRouteReportGeneralAll =
  async (): Promise<PickupRouteReportGeneralModel[]> =>
    await invoke("get_pickup_route_report_general_all");
...
export const getAttendanceLogAll = async (): Promise<
  AttendanceLogModel[]
> => invoke("get_attendance_log_all");

export const getAttendanceLogToday = async (): Promise<
  AttendanceLogModel[]
